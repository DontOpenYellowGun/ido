...
public class LoadingLayout extends FrameLayout {
    ...
    private String networkTexStr;

    private int errorImgRes;
    private int emptyImgRes;
    private int networkImgRes;
    ...
    public LoadingLayout(Context context, AttributeSet attrs) {
        ...
        pageBackground = a.getColor(R.styleable.LoadingLayout_pageBackground, Utils.getColor(mContext, R.color.base_loading_background));

        errorTextStr = a.getString(R.styleable.LoadingLayout_errorText) == null ? mConfig.errorStr : a.getString(R.styleable.LoadingLayout_errorText);
        emptyTextStr = a.getString(R.styleable.LoadingLayout_emptyText) == null ? mConfig.emptyStr : a.getString(R.styleable.LoadingLayout_emptyText);
        networkTexStr = a.getString(R.styleable.LoadingLayout_networkText) == null ? mConfig.netwrokStr : a.getString(R.styleable.LoadingLayout_networkText);

        errorImgRes = a.getResourceId(R.styleable.LoadingLayout_errorImg, mConfig.errorImgId);
        emptyImgRes = a.getResourceId(R.styleable.LoadingLayout_errorImg, mConfig.emptyImgId);
        networkImgRes = a.getResourceId(R.styleable.LoadingLayout_errorImg, mConfig.networkImgId);
    ...
    private void build() {
        ...
        emptyText.setText(emptyTextStr);
        networkText.setText(networkTexStr);
        ...
        errorImg.setImageResource(errorImgRes);
        emptyImg.setImageResource(emptyImgRes);
        networkImg.setImageResource(networkImgRes);
